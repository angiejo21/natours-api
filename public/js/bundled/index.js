...
},{"./login":"aUJqG","./mapbox":"boTQ2","./updateSettings":"j7xLx","./stripe":"boZ94"}],"aUJqG":[function(require,module,exports) {
...
const signup = async (name, email, password, passwordConfirm)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Account created successfully! Check your email.");
            window.setTimeout(()=>{
                location.assign("/");
            }, 1500);
        }
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiYW5naWVqbzIxIiwiYSI6ImNsd2t0Y3N2MzA2YW8ya254NHBzMXhjNjMifQ.7zlAwiivr75PzaXBYLvyMQ";
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/angiejo21/clwktnn2c00m401qscwka9blq",
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === "success") (0, _alerts.showAlert)("success", `${type.toUpperCase()} successfully updated`);
    } catch (err) {
        (0, _alerts.showAlert)("error", err.response.data.message);
    }
};
...
const bookTour = async (tourId)=>{
    const stripe = Stripe("pk_test_51PNxl3H7rHnw7N6bHrcaKmwE80836tVFTHzl32m8nC47IBfvGBwyL1jYv3OE5kfFHEqmDpxhA7fXPRGadJqwTIvm00xYMCasTC");
    //1)get checkout session from API
    try {
        const session = await (0, _axiosDefault.default).post(`http://127.0.0.1:3000/api/v1/booking/checkout-session/${tourId}`);
        console.log(session);
...
},{"axios":"5vw73","@parcel/transformer-js/src/esmodule-helpers.js":"fofuL","./alerts":"97oIL"}]},["iB8Uq","fSlqf"], "fSlqf", "parcelRequire11c7")
